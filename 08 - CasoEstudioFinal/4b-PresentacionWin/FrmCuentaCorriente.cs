...
namespace PresentacionWin
{
    public partial class FrmCuentaCorriente : Form
    {
        ...
        private void ActualizoGrilla()
        {
            ...
            DGVCuentas.DataSource = new PresentacionWin.ServicioWeb.MiServicio().ListarCuentaCorriente().ToList();
        }
        ...
        private void BtnAlta_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                new PresentacionWin.ServicioWeb.MiServicio().AltaCuenta(_cuenta);
