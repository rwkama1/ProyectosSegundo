    ...
    public partial class FrmMovimientos : Form
    {
        ...
        private void BtnAlta_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                new PresentacionWin.ServicioWeb.MiServicio().AltaMovimiento(_movimiento);
        ...
        private void TxtCuenta_Validating(object sender, CancelEventArgs e)
        {
            ...
            try
            {
                ...
                //busco la cuenta
                _objCuenta = null;
                _objCuenta = new PresentacionWin.ServicioWeb.MiServicio().BuscarCuenta(Convert.ToInt32(TxtCuenta.Text));
                if (_objCuenta == null)
