...
<body>
    ...
    <div class="style2">
        ...
        <em><strong class="MiCss">CLIENTES<br />
        <br />
        </strong></em></div>
        ...
        <tr>
            ...
            <td class="style9" colspan="1">
                <asp:Button ID="BtnBusco" runat="server" Text="Buscar" 
                    onclick="BtnBusco_Click" CssClass="MiCss" />
              </td>
        </tr>
        <tr>
            <td class="style8" colspan="1">
        ...
        <tr>
            ...
            <td class="style1">
                <asp:Button ID="BtnAlta" runat="server" Text="Alta" Enabled="False" 
                    onclick="BtnAlta_Click" CssClass="MiCss" />
            </td>
            <td class="style1">
                <asp:Button ID="BtnBaja" runat="server" Text="Baja" Enabled="False" 
                    onclick="BtnBaja_Click" CssClass="MiCss" />
            </td>
            <td>
                <asp:Button ID="BtnModificar" runat="server" Text="Modificar" Enabled="False" 
                    onclick="BtnModificar_Click" CssClass="MiCss" />
            </td>
            <td class="style9" >
                <asp:Button ID="BtnRefresh" runat="server" onclick="BtnRefresh_Click" 
                    Text="Limpiar" CssClass="MiCss" />
            </td>
        </tr>
    </table>
    ...
    <p class="MiCss" style="text-align: center">
    </p>
</body>
</html>
