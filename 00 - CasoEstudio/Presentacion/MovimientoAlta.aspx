    ...
    <table style="width: 32%;" border="1" align="center">
        ...
        <tr>
            <td class="style8" colspan="1">
                Monto:</td>
            <td>
                <asp:TextBox ID="TxtMonto" runat="server" Width="186px" 
                    ontextchanged="TxtMonto_TextChanged"></asp:TextBox>
            </td>
        ...
        <tr>
            <td class="style8" colspan="2">
                <asp:Button ID="BtnAlta" runat="server" Text="Alta" 
                    onclick="BtnAlta_Click" style="text-align: center" CssClass="MiCss" />
            &nbsp;&nbsp;&nbsp;
